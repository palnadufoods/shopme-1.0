...
//			List<String> listStates = service.listStatesByCountry(rate.getCountry());
			
			List<State> listStates = service.listStatesByCountry(rate.getCountry());
			
			List<City> listCites= service.listCitiesByStateName(rate.getState());
			
			model.addAttribute("listCountries", listCountries);
			model.addAttribute("listStates",listStates);
			model.addAttribute("listCities", listCites);
