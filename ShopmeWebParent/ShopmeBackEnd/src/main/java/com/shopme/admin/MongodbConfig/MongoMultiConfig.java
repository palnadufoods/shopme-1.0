package com.shopme.admin.MongodbConfig;
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo0", mongoTemplateRef = "mongoTemplate")
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo1", mongoTemplateRef = "mongoTemplate1")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo2", mongoTemplateRef = "mongoTemplate2")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo3", mongoTemplateRef = "mongoTemplate3")
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo4", mongoTemplateRef = "mongoTemplate4")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo5", mongoTemplateRef = "mongoTemplate5")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo6", mongoTemplateRef = "mongoTemplate6")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo7", mongoTemplateRef = "mongoTemplate7")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo8", mongoTemplateRef = "mongoTemplate8")
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.admin.ProductMgoRepos.repo9", mongoTemplateRef = "mongoTemplate9")
