...
public class CategoryController {
	...
	public String listCategories(Model model, @Param("sortDir") String sortDir) {
		 ...
		 * //service.listCatsInSorting(0,sortDir) model.addAttribute("sortDir",
		 * sortDir); model.addAttribute("listOfCategories", listOfCategories); return
		 * "category/categories";
		 */
	...
	public String listCategories1(Model model, @PathVariable("pageNum") int pageNumber,
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id, Model model,
	...
	/*
	 * @GetMapping("/categories/enable/{id}") public String
	 * enableOrDisable(@PathVariable(name = "id") Integer id,Model
	 * model,@Param("enabled") boolean enabled,RedirectAttributes
	 * redirectAtrributes) { service.UpdateEnabledStatus(id, enabled); String
	 * enbleOrDisable=enabled==true?"Enabled ":"Disabled";
	 * redirectAtrributes.addFlashAttribute("message",
	 * "Category Id "+id+" has been "+enbleOrDisable+" Sucessfully"); return
	 * "redirect:/categories"; }
	 */
