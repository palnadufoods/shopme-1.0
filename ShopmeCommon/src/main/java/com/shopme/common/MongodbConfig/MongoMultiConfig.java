package com.shopme.common.MongodbConfig;
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo0", mongoTemplateRef = "mongoTemplate")
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo1", mongoTemplateRef = "mongoTemplate1")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo2", mongoTemplateRef = "mongoTemplate2")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo3", mongoTemplateRef = "mongoTemplate3")
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo4", mongoTemplateRef = "mongoTemplate4")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo5", mongoTemplateRef = "mongoTemplate5")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo6", mongoTemplateRef = "mongoTemplate6")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo7", mongoTemplateRef = "mongoTemplate7")
//@EnableConfigurationProperties(MongoMultiProperties.class)
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo8", mongoTemplateRef = "mongoTemplate8")
...
@Configuration
@EnableMongoRepositories(basePackages = "com.shopme.common.productMgo.repo9", mongoTemplateRef = "mongoTemplate9")
